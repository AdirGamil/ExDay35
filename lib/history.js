!(function (t, n) {
  ...
  function E(t) {
    ...
    return (
      t &&
        (0 <= (n = t.indexOf('#')) &&
          ((e.hash = t.substr(n)), (t = t.substr(0, n))),
        0 <= (n = t.indexOf('?')) &&
  ...
  ;(g.createBrowserHistory = function (t) {
    ...
    function h(t, n) {
      return (
        ...
        b(
          m(
            { pathname: e.pathname, hash: '', search: '' },
    ...
    (g.createHashHistory = function (t) {
      ...
      function f(t, n) {
        return (
          ...
          b(
            m(
              { pathname: r.pathname, hash: '', search: '' },
              'string' == typeof t ? E(t) : t,
              { state: n, key: S() }
            )
          )
    ...
    (g.createMemoryHistory = function (t) {
      var t =
          void 0 === (t = (n = t = void 0 === t ? {} : t).initialEntries)
            ? ['/']
            : t,
        n = n.initialIndex,
        i = t.map(function (t) {
          var n = b(
            m(
              { pathname: '/', search: '', hash: '', state: null, key: S() },
              'string' == typeof t ? E(t) : t
            )
          )
          return (
      ...
      function u(t, n) {
        return (
          ...
          b(
            m(
              { pathname: c.pathname, search: '', hash: '' },
              'string' == typeof t ? E(t) : t,
              { state: n, key: S() }
            )
          )
